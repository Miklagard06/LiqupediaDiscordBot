...
import re
from dota_modules.player import dota_player
from dota_modules.team import dota_team
from dota_modules.pro_circuit import dota_pro_circuit
from dota_modules.major import dota_major
import unicodedata
...
class dota():
	...
	def get_pro_circuit_details(self):
		soup,__ = self.liquipedia.parse('Dota_Pro_Circuit/2019-20/Rankings/Full')
		pro_circuit = {}
		circuit_object = dota_pro_circuit()
		pro_circuit['rankings'] = circuit_object.get_rankings(soup)
		soup,__ = self.liquipedia.parse('Dota_Pro_Circuit/2019-20/Schedule')
	...
	def get_major_details(self):
		soup,__ = self.liquipedia.parse('ESL_One/Los_Angeles/2020')
		major = {}
		major_object = dota_major()
		major['teams'] = major_object.get_teams(soup)
		#pro_circuit['rankings'] = circuit_object.get_rankings(soup)
		#soup,__ = self.liquipedia.parse('Dota_Pro_Circuit/2019-20/Schedule')
		#pro_circuit['schedule'] = circuit_object.get_schedule(soup)
